...
- Workflow: `~/Documents/ObsidianMemory/Content Vault/workflows/generate-content-from-week.md`
...
- Output backlog: `~/Documents/ObsidianMemory/Content Vault/ideas/weekly-ideas.md`

## Workflow

1. Read workflow, content pillars, positioning, and humanization guide.
2. Search recent notes from:
   ...
   - Legacy ObsidianHugo journals/reviews when relevant.
