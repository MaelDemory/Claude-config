...
2. Do a quick root reconnaissance.
   - Inspect root docs, manifests, workspace files, package/service folders, CI/config, and existing `.claude/docs` or `.claude/architecture` files.
...
5. Synthesize the maps.
   ...
   - Create or update high-level docs such as:
     ...
     - `.claude/docs/entrypoints.md`
     - `.claude/docs/testing-map.md`
     - `.claude/docs/dependency-map.md`
     - `.claude/architecture/_index.md`
