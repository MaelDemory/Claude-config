...
- Content root: `~/Documents/ObsidianMemory/Content Vault`
- Workflow: `~/Documents/ObsidianMemory/Content Vault/workflows/article.md`
- Humanization guide: `~/Documents/ObsidianMemory/Content Vault/guides/seo-humanize.md`
- Content pillars: `~/Documents/ObsidianMemory/Content Vault/guides/content-pillars.md`
- Positioning: `~/Documents/ObsidianMemory/Content Vault/guides/positioning.md`
- Output folder: `~/Documents/ObsidianMemory/Content Vault/medium/`
- Template: `~/Documents/ObsidianMemory/Content Vault/templates/medium-article.md`

## Workflow

1. Read the workflow and all required guides first.
2. Research deeper than for a post:
   ...
   - Search legacy ObsidianHugo when older article, journal, or project context matters.
