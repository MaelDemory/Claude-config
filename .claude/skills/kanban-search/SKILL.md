...
## Boards searched
- `~/Documents/ObsidianMemory/PM/Tasks/` — PM task records
- `~/Documents/ObsidianMemory/Dev Vault/projects/<project>/kanban.md` — Dev kanban / not searched
...
- PM task: `~/Documents/ObsidianMemory/PM/Tasks/<task>.md` / none found
- Dev Vault project: `~/Documents/ObsidianMemory/Dev Vault/projects/<project>/_project.md` / none found
