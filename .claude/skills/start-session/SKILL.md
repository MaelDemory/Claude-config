...
- Vault notes: `~/Documents/ObsidianMemory/...` / none found
- PM task: `~/Documents/ObsidianMemory/PM/Tasks/<task>.md` — <status> / none found
- Dev kanban: `~/Documents/ObsidianMemory/Dev Vault/projects/<project>/kanban.md#<task>` / none found
...
- Dev Vault project: `~/Documents/ObsidianMemory/Dev Vault/projects/<project>/_project.md` / none configured
- PM project: `~/Documents/ObsidianMemory/PM/Projects/<project>.md` / none configured
- Matching PM task: `~/Documents/ObsidianMemory/PM/Tasks/<task>.md` — <status> / none found
- Matching Dev kanban item: `~/Documents/ObsidianMemory/Dev Vault/projects/<project>/kanban.md#<task>` — <status> / none found
...
- Search `~/Documents/ObsidianMemory` with `vault-search` when durable context matters.
